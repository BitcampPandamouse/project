...
plt.legend(['고량주','럼','막걸리','맥주','보드카','소주','와인','위스키','전통주','지역소주'],loc='upper left', ncol = 2, fontsize=6, frameon = False)
plt.savefig('PNGdata/주류 월별 count 2020.01_2020.12.png',dpi = 2000, facecolor = '#eeeeee')